...
describe('Version comparison', () => {
  test('Comparing versions for major/minor version', () => {
    ...
    expect(compareMajorMinorVersions('5.2000.2-phi', '25.0.0-epsilon')).toBe(-1);
    expect(compareMajorMinorVersions('5.2000.2-12', '25.0.0-20250503')).toBe(-1);
    ...
    expect(compareMajorMinorVersions('2025.0.0-gamma', '2025.0.0-iota')).toBe(0);
