...
const cypherShellStyleStringify = (
  ...
  const includeIds = stringStyle === "cypher-with-ids.js";
  if (isNode(value)) {
...
export type CypherStringStyle = "cypher" | "cypher-with-ids.js";
...
const recursiveStringify = (
  value: CypherDataType,
  {
    ...
    quoteStrings = true,
    stringStyle,
  }: RecursiveStringifyOptions = { stringStyle: "json" }
): string => {
...
export const cypherDataToString = (
  ...
  return recursiveStringify(map, { stringStyle });
};
