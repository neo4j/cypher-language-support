...
export function completionCoreErrormessage(
  ...
  const rulesOfInterest: Record<number, string | null> = {
    ...
    [Cypher5Parser.RULE_labelExpression2]: 'a node label / rel type',
    [Cypher5Parser.RULE_labelExpression2Is]: 'a node label / rel type',
    [Cypher5Parser.RULE_procedureName]: 'a procedure name',
    [Cypher5Parser.RULE_stringLiteral]: 'a string',
    [Cypher5Parser.RULE_numberLiteral]: 'a number literal',
