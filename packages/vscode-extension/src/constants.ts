export const CONSTANTS = {
  ...
  MESSAGES: {
    ...
    ERROR_DISCONNECTED_SET_PARAMS: 'You need to be connected to neo4j to set parameters.',
    ERROR_DISCONNECTED_EDIT_PARAMS: 'You need to be connected to neo4j to edit parameters.',
    ...
    ERROR_DISCONNECTED_EXECUTION: 'You need to be connected to Neo4j to run queries',
