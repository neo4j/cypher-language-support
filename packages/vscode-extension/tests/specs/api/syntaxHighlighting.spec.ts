  ...
  test('Correctly highlights cypher statement', async () => {
    await testSyntaxHighlighting({
      ...
      expected: [
        ...
        1, 21, 0, 0, 20, 2, 8, 0, 0, 3, 1, 21, 0, 0, 2, 1, 21, 0, 0, 1, 8, 1, 0,
        0, 8, 1, 21, 0, 0, 1, 2, 21, 0, 0, 4, 5, 9, 0, 0, 8, 1, 21, 0, 0, 1, 1,
        21, 0, 0, 2, 2, 8, 0, 1, 0, 5, 15, 0, 0, 6, 2, 8, 0, 0, 3, 2, 21, 0, 0,
        3, 2, 8, 0, 1, 0, 4, 15, 0, 1, 4, 6, 12, 0, 0, 7, 6, 8, 0, 0, 7, 1, 21,
        0, 0, 4, 1, 21, 0, 0, 2, 1, 8, 0, 0, 2, 2, 15, 0, 0, 17, 1, 8, 0, 0, 3,
        1, 21, 0, 0, 2, 6, 8, 0, 0, 7, 1, 21, 0, 0, 2, 1, 8, 0, 0, 1, 1, 21, 0,
        0, 1, 11, 9, 0, 0, 11, 1, 21, 0, 0, 1, 11, 9, 0, 0, 14, 2, 15, 0, 0, 3,
        8, 8, 0, 0, 8, 1, 21, 0, 1, 4, 6, 12, 0, 0, 7, 6, 8, 0, 0, 7, 1, 21, 0,
        0, 4, 1, 21, 0, 0, 2, 1, 8, 0, 0, 2, 2, 15, 0, 0, 9, 1, 8, 0, 0, 3, 1,
        21, 0, 0, 2, 6, 8, 0, 0, 7, 1, 21, 0, 0, 2, 1, 8, 0, 0, 4, 2, 15, 0, 0,
        3, 5, 8, 0, 2, 0, 6, 15, 0, 0, 7, 8, 8, 0, 0, 8, 1, 21, 0, 0, 2, 5, 8,
        0, 1, 0, 5, 15, 0, 0, 6, 1, 0, 0, 0, 1, 5, 7, 0,
      ],
    });
  });
});
